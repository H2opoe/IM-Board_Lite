...
import { useConnectorCapabilities } from "../../features/profiles/hooks/useConnectorCapabilities";
import { useProfilesPageLifecycle } from "./useProfilesPageLifecycle";
...
export function ProfilesPage({ profiles, onProfilesChange }: Props) {
  const platformOptions = useConnectorCapabilities();
  const {
    formMessage,
  ...
  useProfilesPageLifecycle({
    highlightedProfileId,
    isAboutOpen,
    isBatchManaging,
    officialCliOpen: Boolean(officialCliFlow.profile),
    closeOfficialCliSetup,
    exitBatchManagement,
    resetModalCompositionState,
    setHighlightedProfileId,
