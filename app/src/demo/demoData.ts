...
export const demoProfiles: ImProfile[] = [
  demoProfile("demo_feishu_growth", "feishu", "飞书", "增长运营", 0),
...
const sources = {
  feishuGrowth: source("demo_feishu_growth", "feishu", "飞书", "增长运营", 286, ["新品直播筹备群", "投放素材快审"]),
...
const demoActions: ActionItem[] = [
  ...
  action("reply", "medium", "确认直播间优惠券标题", "运营给出两版优惠券标题，投放同事等待最终版本进素材包。", "demo_feishu_growth", "feishu", "飞书", "增长运营", "新品直播筹备群", "当前更推荐「开播前锁定专属价」，但需要你确认是否符合品牌语气。", iso(11, 36)),
  ...
  action("task", "low", "归档投放素材快审结论", "素材群已经确认三张主图和两条短视频，结论需要同步到项目文档。", "demo_feishu_growth", "feishu", "飞书", "增长运营", "投放素材快审", "主图B和短视频2被选为首轮投放素材，设计同事已上传最终包。", iso(9, 42), "done")
];
...
export function demoDashboard(profileId = "aggregate"): DashboardData {
  ...
  return {
    ...
    topics: [
      ...
      { title: "新品直播准备", summary: "增长运营确认直播间标题、优惠券口径、素材版本和投放节奏。", count: 33, sourceChats: [{ chatName: "新品直播筹备群", isGroup: true }, { chatName: "投放素材快审", isGroup: true }], sources: [sources.feishuGrowth] },
    ...
    chatRank: [
      ...
      { chat: "新品直播筹备群", count: 74, sourceLabel: "飞书（增长运营）" },
    ...
    speakerTop: [
      ...
      { speaker: "许知微", count: 92, sourceLabel: "飞书（增长运营）" },
    ...
    keywords: [
      ...
      { text: "优惠券", weight: 84, count: 36, sources: [sources.feishuGrowth] },
      ...
      { text: "直播素材", weight: 58, count: 19, sources: [sources.feishuGrowth] },
