...
7. 平台内置账号、机器人噪声和系统通知必须忽略，不要生成事项。
...
6. 客户端兼容性提示、成员变更通知和互动系统文本不是用户讨论，不要形成话题，也不要写入 summary。
7. 平台内置账号、机器人噪声和系统通知必须忽略，不要形成话题或关键词。
...
4. 过滤系统通知、成员变更通知、撤回消息、群欢迎语、营销模板、技术 payload、平台内置账号和机器人噪声。
...
8. 对成员变更和互动系统文本必须 category=system_noise、valid=false、scoreMultiplier=0。
