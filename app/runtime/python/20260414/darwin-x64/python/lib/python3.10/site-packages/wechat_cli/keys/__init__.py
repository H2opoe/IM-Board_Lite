...
def extract_keys(db_dir, output_path, pid=None, **kwargs):
    ...
    Args:
        ...
        **kwargs: 平台相关参数，如 macOS 的 app_path、bundle_id、container_id
    ...
    if system == "darwin":
        ...
        return _extract(db_dir, output_path, pid=pid, **kwargs)
    elif system == "windows":
